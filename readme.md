...
Libexo is a multi-platform toolset for characterizing real and fictional planetary systems based on known system properties, it is primarily intended for use as a worldbuilding tool to generate scientifically accurate environments for games, movies, novels and other projects, but it can also be used as an educational tool as well.

## Goals

Libexo is developed with the following basic goals in mind:

 * *Portablility:* Libexo core is written to maximize portability between a variety of platforms including Windows, GNU/Linux, macOS, Solaris, AIX, IRIX and beyond.
...
Libexo will be able to infer a number of properties based on known data, entries in the following list that have been crossed out have been implemented:
